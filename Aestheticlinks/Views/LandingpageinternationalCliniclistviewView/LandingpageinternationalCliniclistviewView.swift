...
struct LandingpageinternationalCliniclistviewView: View {
    @StateObject var landingpageinternationalCliniclistviewViewModel =
        LandingpageinternationalCliniclistviewViewModel()
            ...
            VStack {
                                    ...
                                    HStack {
                                        HStack {
                                            Image("img_vector_gray_901")
                                                ...
                                                .scaledToFit()
                                                .clipped()
                                            Text(StringConstants.kLblInternational)
                                                .font(FontScheme
                                    ...
                                    VStack(alignment: .leading, spacing: 0) {
                                        ...
                                        HStack {
                                            TextField(StringConstants.kMsgSearchHereFor,
                                                      text: $landingpageinternationalCliniclistviewViewModel
                                                          .groupthirtyeightText)
                                                .font(FontScheme
                                                    .kPoppinsRegular(size: getRelativeHeight(14.0)))
                                    ...
                                    HStack {
                                        ...
                                        HStack {
                                            Image("img_flagforflaga")
                                                ...
                                                .scaledToFit()
                                                .clipped()
                                            Text(StringConstants.kMsgGertrudeMelbo)
                                                .font(FontScheme
                                    ...
                                    HStack {
                                        ...
                                        HStack {
                                            Image("img_flagforflagd")
                                                ...
                                                .scaledToFit()
                                                .clipped()
                                            Text(StringConstants.kMsgVRnedamsvejC)
                                                .font(FontScheme
                                                    .kPoppinsSemiBold(size: getRelativeHeight(12.0)))
                                                .fontWeight(.semibold)
                                                .foregroundColor(ColorConstants.WhiteA700)
                                    ...
                                    HStack {
                                        ...
                                        HStack {
                                            Image("img_flagforflagg")
                                                ...
                                                .scaledToFit()
                                                .clipped()
                                            Text(StringConstants.kMsgOranienstrasse)
                                                .font(FontScheme
                                                    .kPoppinsSemiBold(size: getRelativeHeight(12.0)))
                                                .fontWeight(.semibold)
                                                .foregroundColor(ColorConstants.WhiteA700)
                                    ...
                                    HStack {
                                        ...
                                        HStack {
                                            Image("img_saudiarabiasv")
                                                ...
                                                .scaledToFit()
                                                .clipped()
                                            Text(StringConstants.kMsgRiyadhSaudiA)
                                                .font(FontScheme
                                                    .kPoppinsSemiBold(size: getRelativeHeight(12.0)))
                                                .fontWeight(.semibold)
                                                .foregroundColor(ColorConstants.WhiteA700)
                                        ...
                                        .frame(width: getRelativeWidth(149.0),
                                               height: getRelativeHeight(18.0), alignment: .bottom)
                                        .padding(.leading, getRelativeWidth(153.0))
                                    ...
                                    HStack {
                                        ...
                                        HStack {
                                            Image("img_saudiarabiasv")
                                                ...
                                                .scaledToFit()
                                                .clipped()
                                            Text(StringConstants.kMsgPraADasFlore)
                                                .font(FontScheme
                                                    .kPoppinsSemiBold(size: getRelativeHeight(12.0)))
                                                .fontWeight(.semibold)
                                                .foregroundColor(ColorConstants.WhiteA700)
                                    ...
                                    HStack {
                                        ...
                                        HStack {
                                            Image("img_flagforflagi")
                                                ...
                                                .scaledToFit()
                                                .clipped()
                                            Text(StringConstants.kMsgCapelStreetD)
                                                .font(FontScheme
                                                    .kPoppinsSemiBold(size: getRelativeHeight(12.0)))
                                                .fontWeight(.semibold)
                                                .foregroundColor(ColorConstants.WhiteA700)
                ...
                Group {
                    NavigationLink(destination: MorefiltersView(),
                                   tag: "MorefiltersView",
                                   selection: $landingpageinternationalCliniclistviewViewModel
                                       .nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct LandingpageinternationalCliniclistviewView_Previews: PreviewProvider {
    static var previews: some View {
        LandingpageinternationalCliniclistviewView()
    }
}
