...
struct Sortby1View: View {
    @StateObject var sortby1ViewModel = Sortby1ViewModel()
    ...
    var body: some View {
        VStack {
            VStack(alignment: .leading, spacing: 0) {
                ...
                HStack {
                    TextField(StringConstants.kLblRecommended,
                              text: $sortby1ViewModel.groupfiftytwoText)
                ...
                ZStack(alignment: .leading) {
                    ...
                    Group {
                        VStack {
                            HStack(spacing: 0) {
                                TextField(StringConstants.kMsgSortByNames,
                                          text: $sortby1ViewModel.group254Text)
                                    .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(10.0)))
                                    .foregroundColor(ColorConstants.Gray901)
                                    .padding()
                        ...
                        .onChange(of: sortby1ViewModel.group254Text) { newValue in

                            sortby1ViewModel.isValidGroup254Text = newValue
                                .isText(isMandatory: false)
                        }
                        .frame(width: getRelativeWidth(191.0), height: getRelativeHeight(19.0),
                               alignment: .leading)
                        if !sortby1ViewModel.isValidGroup254Text {
                ...
                ZStack(alignment: .leading) {
                    ...
                    Group {
                        VStack {
                            HStack(spacing: 0) {
                                TextField(StringConstants.kMsgSortByNames2,
                                          text: $sortby1ViewModel.group256Text)
                                    .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(10.0)))
                                    .foregroundColor(ColorConstants.Gray901)
                                    .padding()
                                    .keyboardType(.alphabet)
                        ...
                        .onChange(of: sortby1ViewModel.group256Text) { newValue in

                            sortby1ViewModel.isValidGroup256Text = newValue
                                .isText(isMandatory: false)
                        }
                        .frame(width: getRelativeWidth(191.0), height: getRelativeHeight(19.0),
                               alignment: .leading)
                        if !sortby1ViewModel.isValidGroup256Text {
                            Text("Please enter valid text.")
                                .foregroundColor(Color.red)
                                .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(10.0)))
                                .frame(width: getRelativeWidth(191.0),
                ...
                ZStack(alignment: .leading) {
                    ...
                    VStack {
                        HStack(spacing: 0) {
                            TextField(StringConstants.kMsgTopRatedClini,
                                      text: $sortby1ViewModel.group258Text)
                                .font(FontScheme.kPoppinsRegular(size: getRelativeHeight(10.0)))
                                .foregroundColor(ColorConstants.Gray901)
                                .padding()
                        }
            ...
            .frame(width: getRelativeWidth(211.0), height: getRelativeHeight(260.0),
                   alignment: .leading)
...
struct Sortby1View_Previews: PreviewProvider {
