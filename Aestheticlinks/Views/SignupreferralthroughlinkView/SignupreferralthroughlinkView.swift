...
struct SignupreferralthroughlinkView: View {
    @StateObject var signupreferralthroughlinkViewModel = SignupreferralthroughlinkViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    VStack {
                        ...
                        VStack {
                            HStack {
                                TextField(StringConstants.kLbl234abc56d3f,
                                          text: $signupreferralthroughlinkViewModel.inputText)
                                    .font(FontScheme.kPoppinsMedium(size: getRelativeHeight(14.0)))
                                    .foregroundColor(ColorConstants.Black900)
                                    .padding()
                            }
                        ...
                        VStack {
                            Button(action: {
                                signupreferralthroughlinkViewModel
                ...
                Group {
                    NavigationLink(destination: LandingpageCliniclistviewView(),
                                   ...
                                   selection: $signupreferralthroughlinkViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct SignupreferralthroughlinkView_Previews: PreviewProvider {
    static var previews: some View {
        SignupreferralthroughlinkView()
    }
}
